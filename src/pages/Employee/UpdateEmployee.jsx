...
const UpdateEmployee = () => {
  ...
  useEffect(() => {
    const fetchEmployee = async () => {
      try {
        const res = await axios.get(`https://m-back-w7i0.onrender.com/api/employee/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://m-back-w7i0.onrender.com/api/employee/${id}`, employee);
      setModal({
        show: true,
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://m-back-w7i0.onrender.com/api/employee/${id}`);
      setModal({
        show: true,
