    ...
    const fetchFilterOptions = async () => {
      try {
        const res = await axios.get(
          "https://m-back-w7i0.onrender.com/api/userpayment/filters"
        );
    ...
    const fetchAllData = async () => {
      try {
        ...
        const [barRes, pieRes, supplierRes] = await Promise.all([
          axios.get("https://m-back-w7i0.onrender.com/api/userpayment/performance", {
            params,
          }),
          axios.get(
            "https://m-back-w7i0.onrender.com/api/userpayment/performance/payment-types",
            { params }
          ),
          axios.get(
            "https://m-back-w7i0.onrender.com/api/userpayment/performance/top-suppliers",
            { params }
          ),
        ]);
